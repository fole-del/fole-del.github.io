...
})(void 0, function factory(utils, Vector, CanvasRenderer, SvgRenderer) {
  var TAU = utils.TAU;
  var onePoint = {
    x: 1,
    y: 1,
...
})(void 0, function factory(utils, Anchor, Dragger) {
  function noop() {}
...
})(void 0, function factory(Vector) {
...
})(void 0, function factory(utils, Vector, PathCommand, Anchor) {
...
})(void 0, function factory(Anchor) {
...
})(void 0, function factory(utils, Shape) {
...
})(void 0, function factory(utils, Vector, Anchor, Ellipse) {
...
})(void 0, function factory(utils, PathCommand, Shape, Group, Ellipse) {
...
})(void 0, function factory(utils, Vector, PathCommand, Anchor, Ellipse) {
...
})(void 0, function factory(utils, Anchor, Shape, Rect) {
  // ----- BoxRect ----- //
...
})(void 0, function factory(Zdog, CanvasRenderer, SvgRenderer, Vector, Anchor, Dragger, Illustration, PathCommand, Shape, Group, Rect, RoundedRect, Ellipse, Polygon, Hemisphere, Cylinder, Cone, Box) {
